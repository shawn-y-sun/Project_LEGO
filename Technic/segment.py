    ...
    def search_cms(
        ...
        **legacy_kwargs: Any
        ...
        parallel : bool, default False
            ...
            separate Python processes within this segment. The shared DataManager
            must already have its features materialised so that forked workers
            can inherit read-only snapshots without further mutation.
        core : Optional[int], default None
            Maximum number of worker processes to use when ``parallel`` is True.
